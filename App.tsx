...
import type { VocabularyWord, Question, QuestionType } from './types';
import { shuffleArray } from './utils/quizHelper';

type GameState = 'start' | 'playing' | 'finished';
type Feedback = 'correct' | 'incorrect' | 'idle';
...
const App: React.FC = () => {
    ...
    const [correctlyAnsweredWords, setCorrectlyAnsweredWords] = useState<Set<number>>(new Set());

    const generateOptions = useCallback((currentQuestion: Question) => {
    ...
    const startGame = useCallback(() => {
        ...
        const questionTypes: QuestionType[] = ['E_TO_K_MCQ', 'K_TO_E_MCQ', 'K_TO_E_INPUT'];
