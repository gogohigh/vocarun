    ...
    return (
        <div className="flex flex-col h-[600px] text-2xl">
            ...
            <div className="text-center my-8 flex-grow flex flex-col justify-center items-center">
                ...
                <div className="h-28 mt-6 flex items-center justify-center w-full">
                    <div className="w-full max-w-2xl">
                        {feedback === 'idle' && type === 'E_TO_K_MCQ' && (
                            <div className="bg-black/30 p-4 rounded-md animate-fadeIn">
                                <p className="text-xl text-[#00ff41]/80 italic">"{word.exampleSentence}"</p>
                            </div>
                        )}
                        {feedback !== 'idle' && (
                            <div className="bg-black/30 p-4 rounded-md animate-fadeIn">
                                <p className="text-xl text-gray-300 italic">"{word.exampleSentence}"</p>
                                <p className="text-xl text-[#00ff41]/90 mt-2">"{word.koreanTranslation}"</p>
                            </div>
                        )}
                    </div>
                </div>
